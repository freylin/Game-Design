...
public class StateController : MonoBehaviour
{
    ...
    public UnityStandardAssets.Characters.ThirdPerson.AICharacterControl characterControl;
    ...
    public Transform viewpoint;  // The eye position of the enemy
    public Transform target;
    public Vector3 lastSeenPosition;
    public SpriteRenderer stateIcon;
